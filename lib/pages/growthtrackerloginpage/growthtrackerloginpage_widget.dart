...
import 'growthtrackerloginpage_model.dart';
export 'growthtrackerloginpage_model.dart';

class GrowthtrackerloginpageWidget extends StatefulWidget {
  const GrowthtrackerloginpageWidget({Key? key}) : super(key: key);

  @override
  _GrowthtrackerloginpageWidgetState createState() =>
      _GrowthtrackerloginpageWidgetState();
}

class _GrowthtrackerloginpageWidgetState
    extends State<GrowthtrackerloginpageWidget> with TickerProviderStateMixin {
  late GrowthtrackerloginpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GrowthtrackerloginpageModel());
                  ...
                  children: [
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'Enter baby\'s weight at birth',
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        obscureText: false,
                        decoration: InputDecoration(
                          labelText: 'Enter length at birth',
                          labelStyle: FlutterFlowTheme.of(context).labelLarge,
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        obscureText: false,
                        decoration: InputDecoration(
                          labelText: 'Head circumference at  birth',
                          labelStyle: FlutterFlowTheme.of(context).labelLarge,
