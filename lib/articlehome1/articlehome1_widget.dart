...
import 'articlehome1_model.dart';
export 'articlehome1_model.dart';

class Articlehome1Widget extends StatefulWidget {
  const Articlehome1Widget({Key? key}) : super(key: key);

  @override
  _Articlehome1WidgetState createState() => _Articlehome1WidgetState();
}

class _Articlehome1WidgetState extends State<Articlehome1Widget> {
  late Articlehome1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Articlehome1Model());
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.asset(
                                          'assets/images/baby-5-banner-english.jpg',
                                          width: double.infinity,
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        final commArticle01CreateData =
                                            createCommArticle01RecordData(
                                          textField: _model.textController.text,
                                          ratingBar: _model.ratingBarValue,
                                        );
                                        await CommArticle01Record.collection
                                            .doc()
                                            .set(commArticle01CreateData);
