...
import 'article3cleansing_tips_model.dart';
export 'article3cleansing_tips_model.dart';

class Article3cleansingTipsWidget extends StatefulWidget {
  const Article3cleansingTipsWidget({Key? key}) : super(key: key);

  @override
  _Article3cleansingTipsWidgetState createState() =>
      _Article3cleansingTipsWidgetState();
}

class _Article3cleansingTipsWidgetState
    extends State<Article3cleansingTipsWidget> {
  late Article3cleansingTipsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Article3cleansingTipsModel());
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          15.0, 0.0, 15.0, 5.0),
                                      child: Text(
                                        'Giving your a bath is a lovely time to make sure baby is getting all the care they need.',
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                    ...
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(10.0),
                                        child: Image.asset(
                                          'assets/images/baby-towel-dry_(1).webp',
                                          width: double.infinity,
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ...
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(10.0),
                                        child: Image.asset(
                                          'assets/images/MicrosoftTeams-image_(10).png',
                                          width: double.infinity,
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ...
                                    Padding(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(10.0),
                                        child: Image.asset(
                                          'assets/images/mother-with-baby.webp',
                                          width: double.infinity,
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  FFButtonWidget(
                                                    onPressed: () async {
                                                      final commArticle03CreateData =
                                                          createCommArticle03RecordData(
                                                        textField: _model
                                                            .textController
                                                            .text,
                                                        ratingBar: _model
                                                      ...
                                                      await CommArticle03Record
                                                          .collection
                                                          .doc()
                                                          .set(
                                                              commArticle03CreateData);
